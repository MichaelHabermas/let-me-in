/**
 * One-shot browser verification for Epic 6 (Playwright + bundled Chromium).
 * From this directory:
 *   npm install playwright@1.49.1 --prefix .epic6-verify-node
 *   NODE_PATH="$PWD/.epic6-verify-node/node_modules" node .epic6-verify-node/node_modules/playwright/cli.js install chromium
...
const pwLocal = path.join(__dirname, ".epic6-verify-node/node_modules/playwright");
